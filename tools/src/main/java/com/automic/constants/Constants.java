...
public class Constants {
	...
	public static final String AWI_VERSION = "v";
	public static final String AWI_URL = "url";
	public static final String IGNORE_SSL = "ssl";
	public static final String AWI_CONNECTION = "n";
	public static final String AWI_CLIENT = "c";
	public static final String AWI_USERNAME = "u";
